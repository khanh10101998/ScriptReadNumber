...
describe('FILE: view-test/services/see-services-when-testing-true.spec.js - See service when tesing', () => {
  beforeEach(async () => {
    ...
    await initData('service/updateService', {service: 'Giặt ủi', data: {status: 'INACTIVE', isTesting: true}});
  ...
  it('LINE 35 - See new service when status INACTIVE and Testing', async () => { //Tasker thấy việc giặt ủi mới khi công việc có trạng thái INACTIVE và có kiểm tra.
    await loginWithPhoneAndPassword('0834567891', '123456');
    await waitForElement('labelServiceDistrictLaundry task', 5000);
    await expectIdToHaveText('labelServiceDistrictLaundry task', 'GIẶT ỦI - QUẬN 7');
  });
})
