...
describe('FILE: flow-test/home-cooking/accept-task/unverified-tasker-accept-task.spec.js - UNVERIFIED Tasker accept task', () => {
  before(async () => {
  ...
  it('LINE 24 - UNVERIFIED Tasker can not accept task', async () => { //Tasker đăng nhập tài khoản trong trạng thái UNVERIFIED.
