...
describe('FILE: flow-test/home-cooking/cancel-task/company-cancel-task.spec.js - Tasker cancel task', () => {
  beforeEach(async () => {
    ...
    await initData('task/updateTask', [
      { Status: 'CONFIRMED', AcceptedTasker: '0834567892', CompanyPhone: '0834567891', Description: 'Nau an 01' },
      { Status: 'CONFIRMED', AcceptedTasker: '0834567892', CompanyPhone: '0834567891', Description: 'Nau an 02' },
      { Status: 'CONFIRMED', AcceptedTasker: '0834567892', CompanyPhone: '0834567891', Description: 'Nau an 03' },
    ]);
  ...
  it('LINE 47 - Company cancel task and change status to CANCELED', async () => { //Công ty hủy công việc và chuyển sang trạng thái cancel.
