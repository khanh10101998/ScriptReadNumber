...
describe('FILE: flow-test/home-cooking/cancel-task/tasker-cancel-task-free-charge.spec.js - Tasker cancel task', () => {
  beforeEach(async () => {
  ...
  it.skip('LINE 34 - Tasker cancel task with reason Nearby Task Place', async () => { //skip
