...
describe('FILE: flow-test/home-cooking/cancel-task/tasker-cancel-promotion-task.spec.js - Tasker cancel promotion task', () => {
  beforeEach(async () => {
    ...
    await initData('task/updateTask', [
      ...
      { Status: 'CONFIRMED', AcceptedTasker: '0834567891', Description: 'Nau an 02', PromotionCode: 'abc123' },
  ...
  it('LINE 43 - Tasker cancel promotion task', async () => { //Tasker hủy công việc nấu ăn khuến mãi với lý do sự cố bất khả kháng.
