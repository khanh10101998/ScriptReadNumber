...
describe('FILE: flow-test/home-cooking/cancel-task/tasker-cancel-task-near-by-place.spec.js - Tasker cancel task', () => {
  beforeEach(async () => {
  ...
  it('LINE 30 - Tasker cancel task: waiting for canceling task', async () => { //Tasker hủy việc nấu ăn.
  ...
  it('LINE 57 - Tasker cancel task: Task time has not been comming yet.', async () => { //Tasker hủy việc nấu ăn với lý do không thể liên lạc với khách hàng khi chưa đến 15 phút sau khi nhận việc.
    ...
    await initData('task/createTask', [
      { ServiceName: 'Nấu ăn', AskerPhone: '0834567890', Description: 'Nau an 01' },
      { ServiceName: 'Nấu ăn', AskerPhone: '0834567890', Description: 'Nau an 02', Date: 'today', Time: `${hour},${minute}` },
      { ServiceName: 'Nấu ăn', AskerPhone: '0834567890', Description: 'Nau an 03' },
    ]);
    await initData('task/updateTask', [
      { Status: 'CONFIRMED', AcceptedTasker: '0834567891', Description: 'Nau an 01' },
