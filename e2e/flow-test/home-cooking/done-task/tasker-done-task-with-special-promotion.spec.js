...
describe('FILE: flow-test/home-cooking/done-task/tasker-done-task-with-special-promotion.spec.js - Tasker done task promotion', () => {
  before(async () => {
    ...
    await initData('task/createTask', [
      { ServiceName: 'Nấu ăn', AskerPhone: '0834567890', Description: 'Nau an 01', SpecialPromotionAndRequirement: true },
    ]);
  ...
  it('LINE 30 - Tasker done task with special promotion', async () => { //Tasker hoàn thành việc nấu ăn với mã khuyến mãi đặc biệt.
