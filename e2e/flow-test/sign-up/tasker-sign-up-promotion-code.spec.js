...
describe('FILE: flow-test/sign-up/tasker-sign-up-promotion-code.spec.js - Promotion code', () => {
  before(async () => {
  ...
  it('LINE 20 - New tasker sign up with promotion code', async () => { //Tasker đăng ký với mã khuyến mãi hợp lệ.
