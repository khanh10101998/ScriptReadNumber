...
describe('FILE: flow-test/sign-up/tasker-sign-up-see-task.spec.js - See task', () => {
  before(async () => {
    try {
  ...
  it('LINE 21 - Tasker sign up, account is verified, a Task is posted, see that Task on home page', async () => { //Tasker thấy công việc mới với tài khoản được active.
