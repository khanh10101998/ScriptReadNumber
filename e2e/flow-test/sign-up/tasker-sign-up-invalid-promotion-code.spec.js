...
describe('FILE: flow-test/sign-up/tasker-sign-up-invalid-promotion-code.spec.js - invalid promotion code', () => {
  beforeEach(async () => {
    try {
  ...
  it('LINE 30 - New tasker sign up with invalid promotion code', async () => { //Tasker đăng ký với mã khuyến mãi hết hạn.
